public class Strings{
	...
	String text = "Object Oreiented Programming";
	...
	System.out.println("\nLength of the given text: "+text.length());
		...
		System.out.println("\n__Comparison__");
		System.out.println("\nIf the value is both 0, both are equal. Otherwise unequal!");
		System.out.println("\nText for Comparison:objcect oriented programming->"+ text.compareTo("Object Oriented Programming"));
